...
Version  : 1.8.9
Release  : 98
URL      : https://cran.r-project.org/src/contrib/plyr_1.8.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plyr_1.8.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737152883
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/plyr/libs/plyr.so
/V4/usr/lib64/R/library/plyr/libs/plyr.so
